...
def _sample_symbol_values(captured: dict[str, object] | Mapping[str, object]) -> str:
    items: list[str] = []
    for symbol, price in list(captured.items())[:2]:
...
async def main() -> int:
    ...
    cases: list[ProviderCheckCase] = [
        ...
        ProviderCheckCase(
            ...
            missing_credentials_reason=(
                None if fixer_key else "missing FIXER_API_KEY"
            ),
        ),
        ProviderCheckCase(
            name="currencylayer",
        ...
        ProviderCheckCase(
            ...
            instruments=[
                ...
                _instrument("GAZP", DataCategory.STOCKS, "moex", "GAZP"),
            ],
        ),
        ProviderCheckCase(
            name="tinkoff",
            ...
            missing_credentials_reason=(
                None
                if tinkoff_token
                else "missing TINKOFF_TOKEN or TINKOFF_API_TOKEN"
            ),
        ),
        ProviderCheckCase(
            ...
            instruments=[
                _instrument("AAPL", DataCategory.STOCKS, "alphavantage", "AAPL"),
            ],
            missing_credentials_reason=(
        ...
        ProviderCheckCase(
            ...
            instruments=[
                _instrument("AAPL", DataCategory.STOCKS, "twelvedata", "AAPL"),
            ],
            missing_credentials_reason=(
